...
export interface paths {
    ...
    "/people/{id}/merge": {
         ...
         */
        post: operations["mergePersonLegacy"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
